...
public class Main {
    public static void main(String[] args) {
        ...
        methodLeastSquares.fillMatrix();
        System.out.println("methodLeastSquares.getMatrix() = " + methodLeastSquares.getMatrix());
        methodLeastSquares.computeY();
        System.out.println(methodLeastSquares.solve());
    }
}
